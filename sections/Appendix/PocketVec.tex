...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.9\linewidth]{figures/PocketVec/Supplementary/FigS4.png}
  \caption{
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=1\linewidth]{figures/PocketVec/Supplementary/FigS5.png}
  \caption{
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.7\linewidth]{figures/PocketVec/Supplementary/FigS6.png}
  \caption{
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.85\linewidth]{figures/PocketVec/Supplementary/FigS11.png}
  \caption{
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=1\linewidth]{figures/PocketVec/Supplementary/FigS13.png}
  \caption{
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.7\linewidth]{figures/PocketVec/Supplementary/FigS16.png}
  \caption{
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.75\linewidth]{figures/PocketVec/Supplementary/FigS17.png} 
  \caption{
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.65\linewidth]{figures/PocketVec/Supplementary/FigS18.png}
  \caption{
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.9\linewidth]{figures/PocketVec/Supplementary/FigS19.png}
  \caption{
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=1\linewidth]{figures/PocketVec/Supplementary/FigS22.png}
  \caption{
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=1\linewidth]{figures/PocketVec/Supplementary/FigS23.png}
  \caption{
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.85\linewidth]{figures/PocketVec/Supplementary/FigS27.png}
  \caption{
  Correlation between PocketVec similarity (x-axis, defined as 1-PocketVec distance), structural similarity (y-axis, C$\alpha$ RMSD) and sequence identity (color) among pockets located at the same Pfam domain (max. 10) in the AF2-LIG pocket set. Pearson Corr. Coeff. between PocketVec similarity and sequence identity: 0.57 (p-value <10\textsuperscript{-100}). Pearson Corr. Coeff. between PocketVec similarity and RMSD: -0.35 (p-value <10\textsuperscript{-35}). 
  }
...
\begin{figure}[htbp]
  ...
  \caption{
  Relationship between PocketVec similarity and experimentally determined compound-target pairs. PDB-LIG vs PDB-PD, AF2-LIG and AF2-PD comparisons between PocketVec distance and number of shared compounds among proteins having experimental binding data in ChEMBL and BindingDB (a, b, c) and Offensperger et al.\cite{offensperger_large-scale_2024} (d, e, f).
...
\begin{figure}[htbp]
  ...
  \caption{
  Number of inhibitors per kinase obtained from \textbf{a)} Kleager et al. (2017 set)\cite{klaeger_target_2017} and \textbf{b)} Reinecke et al. (2023 set)\cite{reinecke_chemical_2023} binarized at 30 nM. Each bar corresponds to the number of kinases (y-axis) having the specified number of inhibitors (x-axis). 
  }
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.85\linewidth]{figures/PocketVec/Supplementary/FigS30.png}
  \caption{
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.9\linewidth]{figures/PocketVec/Supplementary/FigS31.png}
  \caption{
...
\csvreader[
    longtable=|C{1.8cm}|C{0.7cm}|C{0.6cm}|C{0.7cm}|C{0.8cm}|C{0.6cm}|C{0.6cm}|C{0.6cm}|C{0.6cm}|C{0.6cm}|C{0.6cm}|C{0.6cm}|,  % Adjust the widths as needed
...
\begin{table}[h!]
    \centering
    \caption{Kinase-inhibitor matrices from Kleager et al. (2017 set)\cite{klaeger_target_2017} and Reinecke et al. (2023 set)\cite{reinecke_chemical_2023} binarized at 30 nM. Both matrices can be found in our \href{https://gitlabsbnb.irbbarcelona.org/acomajuncosa/pocketvec}{GitLab repository} (see \hyperref[PocketVec_Code]{Code and data availability}) in a XLSX file format.}
